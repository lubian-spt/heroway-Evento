...
function createBoard() {
  ...
  function createEnemy(options) {
    const enemy = createElement({
      ...
      setInterval(() => {
        const direction = ['ArrowUp','ArrowDown','ArrowRight','ArrowLeft'];
...
board.createEnemy({ top: TILE_SIZE * 15, left: TILE_SIZE * 4 });
board.createHero({ top: TILE_SIZE * 2, left: TILE_SIZE * 2 });